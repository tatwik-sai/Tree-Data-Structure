class Tree:
    ...
    def add_node(self, node: tuple):
        ...
        :param node: tuple, Tuple with parent and child.
    ...
    def add_children(self, parent, children: list):
        """
        Adds multiple children to the parent.
        :param parent: parent name.
        :param children: List of children of the parent.
        """
...
if __name__ == '__main__':
    a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v = ['a'], ['b'], ['c'], ['d'], ['e'], ['f'], ['g'], ['h'], ['i'], 'j', \
                                                                       'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v'
    tree = Tree()
    tree.add_children('nil', [a])
    tree.add_children(a, [b, c, d])
    tree.add_children(b, [e, f])
    tree.add_children(c, [g, h])
    tree.add_children(d, [i, j])
    tree.add_children(e, [k, l])
    tree.add_node((a, m))
